<x-app-layout>
    <div class="max-w-3xl mx-auto px-6 py-12 text-center">
        <h1 class="text-4xl font-bold text-indigo-600 dark:text-indigo-400 mb-4">🗳️ {{ __("Welcome to PickRoom!") }}</h1>
        <p class="text-lg text-gray-700 dark:text-gray-300 mb-8">
            {{ __("Got opinions? Cast your vote or create your own poll and see what the crowd thinks!") }}
        </p>
        ...
        <div class="text-left bg-gray-50 dark:bg-gray-800 p-6 rounded-xl shadow">
            <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">✨ {{ __("How It Works") }}</h2>
            <ul class="space-y-3 text-gray-700 dark:text-gray-300">
                <li>✅ {{ __("Browse polls and cast your vote in seconds") }}</li>
                <li>✅ {{ __("Instantly see results") }}</li>
                <li>✅ {{ __("Got a burning question? Create your own poll!") }}</li>
                <li>✅ {{ __("Share your polls with friends and watch the results roll in") }}</li>
            </ul>
        </div>
    </div>
</x-app-layout>